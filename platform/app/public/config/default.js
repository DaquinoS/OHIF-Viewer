...
window.config = {
  ...
  dataSources: [
    ...
    {
      namespace: '@ohif/extension-default.dataSourcesModule.dicomweb',
      sourceName: 'dicomServer',
      configuration: {
        friendlyName: 'DICOM Server',
        name: 'DCM4CHEE',
        wadoUriRoot: 'http://localhost:5000/dicom',
        qidoRoot: 'http://localhost:5000/dicom',
        wadoRoot: 'http://localhost:5000/dicom',
        qidoSupportsIncludeField: false,
        imageRendering: 'wadors',
        thumbnailRendering: 'wadors',
        enableStudyLazyLoad: true,
